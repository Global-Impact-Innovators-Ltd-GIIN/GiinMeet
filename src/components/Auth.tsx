      ...
      <div className="glass-panel" style={{
        ...
        {!otpSent && (
          <button 
            ...
            style={{ width: '100%', borderColor: '#1E293B', color: 'white', justifyContent: 'center', textTransform: 'capitalize' }}
          >
            <Globe size={16} color="var(--color-accent)" />
            <span>{isLogin ? 'Sign In using Google' : 'Sign Up using Google'}</span>
          </button>
        )}
